# https://raw.githubusercontent.com/jsbain/GitHubGet/master/GitHubGet.py
#
...
# 
##   javascript:(function()%7Bif(document.location.href.indexOf('http')===0)document.location.href='pythonista://./thirdparty/GitHubGet?action=run&argv='+document.location.href;%7D)();
